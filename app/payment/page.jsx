...
const Payment = () => {
  ...
  return (
    ...
    <div className='flex flex-col justify-center items-center h-[90vh]'>
        ...
        <h1 className='text-[#1E293B] mt-3 sm:mt-10 mb-4 sm:mb-6 font-medium text-2xl'>Payment Successful</h1>
        <p className='text-[#64748B] text-base'>Thank you for ordering </p>
        <p className='text-[#64748B] text-base mb-4 sm:mb-8'>Your payment is successfully completed</p>
        <Link href={'/'}>
