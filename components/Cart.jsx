...
const Cart1 = () => {
  ...
  return (
    ...
    <div className="flex w-screen justify-center ">
      <div className="sm:w-11/12 w-screen max-w-[1040px] p-12 border-[1px] mt-12 mb-16 border-[#0b69ff36]">
        ...
        {count.map((e, index) => (
          <div key={e.id} className="grid grid-cols-3 gap-6 justify-items-center place-items-center">
        ...
        <div className="grid grid-cols-3 justify-items-center place-items-center">
          <h1 className="place-self-start text-[#3E4C59] text-2xl font-medium">Order Total:</h1>
          <p></p>
          <div className="flex flex-col gap-8">

          <h1 className="text-[#3E4C59] text-2xl font-medium ">&#8377; {total}.00</h1>
          <Link href="/payment" >
          <button className="text-white bg-[#F7931E] py-2 px-4 rounded-lg" onClick={()=>dispatch(removeitems())}>Place Order</button>
          </Link>
          </div>
        </div>
      </div>
